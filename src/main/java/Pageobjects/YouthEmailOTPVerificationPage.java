...
public class YouthEmailOTPVerificationPage extends abstractComponents {
	...
	public YouthEmailOTPVerificationPage(Page page) {
		super(page);
		this.page = page;
        ...
        closePopupQuiz = page.locator("//i[@class='fa fa-times']");
	...
	public void register_verifyOTP() throws InterruptedException {
     ...
     // Open a new browser tab in the same browser session (same cookies, same context)
        ...
        // Click the refresh button to fetch the latest emails (OTP mail may arrive late)
        ...
        mailPage.frameLocator("iframe#ifmail")
                .locator("//p[contains(text(),'Your one-time password')]")
                .waitFor();
        ...
        // Example text:
        // "Your one-time password (OTP) for registering on MyBharat is 482913. This OTP is valid for 10 minutes."
